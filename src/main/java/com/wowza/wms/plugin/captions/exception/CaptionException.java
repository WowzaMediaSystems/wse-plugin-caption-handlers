...
package com.wowza.wms.plugin.captions.exception;

import java.nio.charset.StandardCharsets;

public class CaptionException extends Throwable
{
    private final int status;

    public CaptionException(String message, int status)
    {
        super(message);
        this.status = status;
    }
    ...
    public String getMessage()
    {
        ...
        if (msg != null && msg.getBytes(StandardCharsets.UTF_8).length > 123)
        {
